<?php 
	...
	$class 	   = isset( $sliderParams['fullwidth'] ) && !empty($sliderParams['fullwidth']) ? $sliderParams['fullwidth']: 'ed';
	$fullwidth = $class =="ed"?"off":"on";

 
?>
<?php if( $class =="ed") { ?>
<div class="layerslider-wrapper clearfix" style="max-width:<?php echo $sliderParams['width'];?>px;">
<?php } ?>
