        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><?php if ($product['price']) { ?>
              ...
              <?php } ?></td>
            <td class="text-right">
                <button data-loading-text="Loading..." class="btn btn-primary" type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
                    <span class="hidden-sm hidden-xs"><?php echo $button_cart; ?></span><span class="hidden-md hidden-lg"><i class="fa fa-shopping-cart"></i></span>
                </button>
