    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="table-responsive"><table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
            <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block"
                       onclick="cart.addcart('<?php echo $product['product_id']; ?>');"/>

                <a href="<?php echo $product['remove']; ?>"
                   class="btn btn-danger btn-block"><?php echo $button_remove; ?></a>
