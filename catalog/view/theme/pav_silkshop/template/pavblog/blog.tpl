...
<div class="container-inside">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
		...
		<!-- Start Div Content -->
		<div class="pav-blog-detail pav-filter-blogs">
						...
						<form action="<?php echo $comment_action;?>" method="post" id="comment-form" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group required">
									<label class="col-sm-3 col-xs-12 control-label" for="comment-user"><?php echo $objlang->get('entry_name');?></label>
								...
								<div class="form-group required">
									<label class="col-sm-3 col-xs-12 control-label" for="comment-email"><?php echo $objlang->get('entry_email');?></label>
									<div class="col-sm-9 col-xs-12">
								...
								<div class="form-group required">
									<label class="col-sm-3 col-xs-12 control-label" for="comment-comment"><?php echo $objlang->get('entry_comment');?></label>
									<div class="col-sm-9 col-xs-12">
